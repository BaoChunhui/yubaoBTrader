...
from yubaoBtrader.event import Event, EventEngine
from yubaoBtrader.trader.engine import BaseEngine, MainEngine
from yubaoBtrader.trader.object import (
    OrderRequest,
    OrderQueryRequest,
    SubscribeRequest,
    HistoryRequest,
...
from yubaoBtrader.trader.event import (
    EVENT_TICK,
    EVENT_ORDER,
    EVENT_TRADE,
    EVENT_POSITION
)
from yubaoBtrader.trader.constant import (
    Direction,
    OrderType,
    Interval,
    Exchange,
...
from yubaoBtrader.trader.utility import load_json, save_json, extract_vt_symbol, round_to
from yubaoBtrader.trader.converter import OffsetConverter
from yubaoBtrader.trader.database import BaseDatabase, get_database
...
class CtaEngine(BaseEngine):
    ...
    def load_strategy_class(self) -> None:
        ...
        self.load_strategy_class_from_folder(path1, "yubaoBtrader.app.cta_strategy.strategies")
