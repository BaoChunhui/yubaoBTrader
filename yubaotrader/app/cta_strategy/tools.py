...
from yubaotrader.trader.object import BarData, TradeData, Direction
from yubaotrader.app.cta_strategy import StopOrder
from yubaotrader.trader.object import OrderData
from yubaotrader.trader.constant import Status
from yubaotrader.trader.utility import round_to
from yubaotrader.app.cta_strategy.base import (
    BacktestingMode,
    EngineType,
    STOPORDER_PREFIX,
    StopOrder,
...
class TradeResult:
    ...
    def update_trade(self, trade: TradeData) -> bool:
        ...
        if not round_to(self.net_volume * 1000, 1):
